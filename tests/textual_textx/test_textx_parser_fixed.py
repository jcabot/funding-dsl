#!/usr/bin/env python3
"""
Comprehensive tests for TextX-based Funding DSL Parser (Fixed Version)
"""
...
class TestTextXParser(unittest.TestCase):
    ...
    def test_complete_configuration(self):
        ...
        self.assertEqual(hosting_goal.target_amount.value, 100.0)
        self.assertEqual(hosting_goal.current_amount.value, 50.0)
        self.assertIsNone(hosting_goal.deadline)
        
        dev_goal = config.goals[1]
        self.assertEqual(dev_goal.name, "Development")
        self.assertEqual(dev_goal.target_amount.value, 500.0)
        self.assertEqual(dev_goal.current_amount.value, 0.0)
    ...
    def test_optional_elements(self):
        ...
        goal = config.goals[0]
        self.assertEqual(goal.current_amount.value, 0.0)  # default
